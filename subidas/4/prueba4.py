...
# ## Aplico modelo
#
# Voy a aplicar un modelo KNN que busca el mejor valor de N entre 1 y 30
...
values = cross_val_score(knn_model, X_train, y_train, scoring='neg_mean_squared_log_error', cv=5)
print(values)
print(values.mean())
