...
# ## Aplico modelo
#
# Voy a aplicar un modelo de red neuronal
...
parameters = {
                ...
                #"max_iter": range(200, 1000) # Maximum number of iterations. The solver iterates until convergence (determined by 'tol') or this number of iterations
             }
#grid_search = GridSearchCV(MLPRegressor(), parameters)
#print("Ajustando mejores parámetros para el modelo multilayer perceptron (MLP) base...")
...
bagged_model = MLPRegressor(activation='identity', solver='lbfgs', learning_rate='constant', max_iter=400)
