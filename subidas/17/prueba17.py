...
from sklearn.ensemble import BaggingRegressor, GradientBoostingRegressor, HistGradientBoostingRegressor, StackingRegressor
...
def obtener_hist_grad_boosting_reg():
    parameters = {
                    ...
                    'max_iter': [i*10 for i in range(10,15)],
...
def obtener_svm_reg():
    ...
    bagged_model = SVR(kernel='linear', degree=0, gamma='scale', coef0=0,
                    tol=0.001, C=250, epsilon=1.0, shrinking=True,
